    ...
    <div class="container">
      ...
      <img 
        ...
        <h3 align="center" style="margin-top:4%;color:#fff"><?php echo $wtitle;?></h3>
                <div class=" o-hidden border-0 shadow-lg my-5 text-success">

                    <div class="" >
                        <!-- Nested Row within Card Body -->
                    <form name="login" method="post" class="d-flex align-items-center justify-content-center">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="password-recovery.php" style="font-weight:bold; color:white;">Forgot Password?</a>

                                    </div>   

                                         <div class="text-center">
                                        <a class="small" href="../index.php" style="font-weight:bold; color:white"><i class="fa fa-home" aria-hidden="true"></i> Home Page</a>
                                    </div>
